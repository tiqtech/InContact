var _PrefsAssistantBase = {
	initialize:function(model) {
		this.model = model;
		this.prefs = null;
		this.handlers = new HandlerManager(this, ["handleAutoDialChange", "handleAllowRotateChange", "handleIconChange", "handleThemeChange", "handleNamePositionChange", "handleContactSizeChange", "handleCloseActionChange", "handleStartModeChange"]);
	},
	setup:function() {
		...
		$('preferencesTitle').insert($L("Preferences"));
		$('generalPreferencesTitle').insert($L("General"));
		$('contactPreferencesTitle').insert($L("Contact"));
		...
		Mojo.Event.listen($('fieldStartMode'), Mojo.Event.propertyChange, this.handlers.handleStartModeChange);
	...
	cleanup:function() {
		...
		Mojo.Event.stopListening($('fieldStartMode'), Mojo.Event.propertyChange, this.handlers.handleStartModeChange);
